  ...
  return (
    <div className="p-2 pt-5 md:p-8 flex justify-between  border-b-2 flex-col md:flex-row bg-background dark:bg-background">
      <div className=" pl-4 md:pt-12">
        ...
        <div className="flex"><h1 className="text-black font-bold text-[3.5rem] md:text-[5rem] font-League -tracking-[0.3rem] leading-[4rem] dark:text-white  ">Your Pet</h1> <div className="h-20 w-20 bg-red-500 rounded-3xl   flex justify-center"> <img src={logo} className=" h-24 md:h-28" alt="logo" /></div></div>
