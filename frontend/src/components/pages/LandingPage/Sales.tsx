  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="flex flex-col overflow-hidden rounded-lg bg-yellow-500 sm:flex-row md:h-80">
      ...
      <div className="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
        ...
        <p className="mb-8 max-w-md font-cab text-primary font-semibold hidden md:block">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</p>
