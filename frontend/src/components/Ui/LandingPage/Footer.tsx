      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="flex flex-col items-center justify-between gap-2 md:flex-row">
          ...
          <form className="flex w-full gap-2 md:max-w-md">
            ...
            <button className="inline-block rounded bg-white px-8 py-2 text-center text-sm font-semibold text-red-500 outline-none ring-red-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:text-red-600 md:text-base">Send</button>
          </form>
        </div>
      </div>
    </div>
        ...
        <div className="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-6 lg:gap-8">
          <div className="col-span-full lg:col-span-2">
            <div className="mb-4 lg:-mt-2">
              <a href="#" className="inline-flex items-center gap-2 text-xl font-bold text-black dark:text-white md:text-2xl" aria-label="logo">
              Petopia🐶
              </a>
            </div>
