      ...
      <div className="main p-5 mx auto ">
        <div className="flex gap-x-14 flex-col md:pl-10 md:flex-row">
          <div className="flex justify-start md:pl-10 p-2 md:p-2">
            <ImgBox petImg={data?.petImages} />
          </div>
          <div className="Pet Description ">
            <div className="">
              <div className="mb-2 md:mb-4 pt-2">
                <span className="mb-0.5 inline-block font-cab font-extrabold text-black dark:text-white">{data?.petType} Bread:  <span className="text-red-500 font-semibold"> {data?.petBread}</span></span>
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl">{data?.petName}</h2>
              </div>
              ...
              <h1 className="mb-2 flex gap-x-2 items-center cursor-pointer  font-cab font-extrabold text-red-600">
                <TooltipProvider>
                  <Tooltip>
