    ...
    return (
        <>
            <div className="border-t pt-10 pb-5">
                <div>
                    <h2 className="text-center text-red-500 font-bold text-2xl md:text-4xl">
                        FAQ<span className="text-black dark:text-white">?</span>
                    </h2>
                </div>
                <div className="px-10 md:px-40 font-mad">
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            <AccordionTrigger>
                                What types of pets are available for purchase on your website?
                            </AccordionTrigger>
                            <AccordionContent>
                        ...
                        <AccordionItem value="item-2">
                            <AccordionTrigger>
                                How do I ensure the well-being and health of the pet I purchase through your platform?
                            </AccordionTrigger>
                            <AccordionContent>
                        ...
                        <AccordionItem value="item-3">
                            <AccordionTrigger>
                                Can I return or exchange a pet if it doesn't suit my needs or lifestyle?
                            </AccordionTrigger>
                            <AccordionContent>
