...
export default function ProductDetails() {
    ...
    const { isLoading, error, data } = useQuery({
        queryKey: ["GetSingleProductDetails", id],
        ...
        <>
            <div className="main p-5 mx auto ">
                    ...
                    <div className="Pet Description ">
                        <div className="">
                            <div className="mb-2 md:mb-4 pt-2">
                                <span className="mb-0.5 inline-block font-cab font-extrabold text-black dark:text-white">
                                    {" "}
                                    Category:{" "}
                ...
                <div className="mt-10 md:mt-12 lg:mt-16">
                    <div className="mb-3 text-xl font-semibold font-leag text-red-500">
                        Description
                    </div>
                    <p className="text-black dark:text-white font-leag">
                        ...
                        , a charming{" "}
                        <span className="text-red-500">{data?.petBread}</span>{" "}
                        {data?.petType} with a heart of gold 💖. Despite
                        battling flea infestation and ear infections,{" "}
                        <span className="text-red-500">{data?.petName}</span>'s
                        spirit remains resilient. This playful companion thrives
                        on affection and loves adventures. With a glossy coat
                        and soulful eyes, <span>{data?.petName}</span> captures
                        hearts effortlessly. Although not yet adopted,{" "}
                        <span>{data?.petName}</span> eagerly awaits a forever
                        home where loyalty and companionship reign supreme.
                        Don't let health challenges deter you; with proper care,{" "}
                        <span>{data?.petName}</span> promises unwavering love
                        and joy. Welcome <span>{data?.petName}</span> into your
                        life, and witness the transformation of a pet into
                        family.
                    </p>
                </div>
            </div>
